                            ...
                            <div class="card-body">           
                                <div class="add-role" >
                                    ...
                                    <form action="editRole" method="post" style="display: flex">
                                        ...
                                        <input style="width: 200px; height: 40px; border: 2px solid black; border-radius: 5px;" type="text" placeholder="Rode name" name="name" value="${c.name}"><br>

                                        <input style="width: 200px; height: 40px; border: 2px solid black; border-radius: 5px;" type="text" placeholder="Authorize" name="authorize" value="${c.authorize}"><br>

                                        <a href="listRole"><button value="edit" >Edit</button></a>
                                    </form>
                                </div>
                            </div>
                        </div>
