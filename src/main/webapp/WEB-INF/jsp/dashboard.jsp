                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body text-center p-5">
                                ...
                                <p class="mb-4">Ready to get started? Let us know now! It's time to start building
                                    that dashboard you've been waiting to create!</p>
...
<script src="assets/js/dashboard/chart-bar-demo.js"></script>
