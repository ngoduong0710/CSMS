                        ...
                        (function () {
                            ...
                            function h(t, e, s) {
                                ...
                                switch (o) {
                                    ...
                                    case s._const.replaceElement:
                                        ...
                                        i.parentNode.replaceChild(d(e[s._const.newValue], h, s), i);
                                        break;
                                    ...
                                    case s._const.addElement:
                                        var u = (f = r.slice()).splice(f.length - 1, 1)[0];
                                        if (!((i = c(t, f)) instanceof Element)) return !1;
                                        i.insertBefore(
                                            d(
                                                e[s._const.element],
                                    ...
                                    case s._const.addTextElement:
                                        var f;
                                        if (
                                            ((u = (f = r.slice()).splice(f.length - 1, 1)[0]),
                            ...
                            var S = {
                                ...
                                C = function (t) {
                                    ...
                                    for (var a = new RegExp(V), o = null, r = !1; !r;)
                                ...
                                L = function (t, e) {
                                    ...
                                    return (
                                        t.replace(O, function (o, r) {
                                            ...
                                            if (l) {
                                                if (
                                                    ((s = C(o)), n++, !s.voidElement && h && "<" !== h)
                                                ) {
                                                    s.node.childNodes || (s.node.childNodes = []);
                                                    var f = $(t.slice(c, t.indexOf("<", c)));
                                    ...
                                    return (
                                        ...
                                        (t.prototype.attemptGroupRelocation = function (
                                            ...
                                            for (
                                                ...
                                                h = (function (t, e, s) {
                                                    var i = t.childNodes
                                                        ? y(t.childNodes.length, !0)
                                                        : [],
                                                        n = e.childNodes
                                                            ? y(e.childNodes.length, !0)
                                                            : [],
                                                        a = 0;
                                                    return (
                                                ...
                                                (this.$d = (function (t, e, s) {
                                                    try {
                                                        ...
                                                        return h
                                                            ...
                                                            : s
                                                                ? new Date(Date.UTC(m, g, f, b, v, w, y))
                                                                : new Date(m, g, f, b, v, w, y);
                                                    } catch (t) {
                                                        return new Date("");
                                                    }
                                                })(e, r, i)),
                            ...
                            const q = (t, e) => {
                                ...
                                W = (t, e, s, i, n) => {
                                    ...
                                    t.headings
                                        ? (o.headings = t.headings.map((t) => F(t)))
                                        : e?.tHead
                            ...
                            const z = {
                                ...
                                labels: {
                                    ...
                                    perPage: "mục trên một trang",
                                    noRows: "Không tìm thấy mục nào",
                                    noResults: "Không có kết quả nào phù hợp với yêu cầu tìm kiếm của bạn",
                                    info: "Hiển thị từ {start} đến {end} trong tổng số {rows} mục",
                                },
                                template: (t, e) =>
                            ...
                            (s.DataTable = class {
                                constructor(t, e = {}) {
                                    ...
                                    (this.options = {
                                        ...
                                        (this._dd = new A(this.options.diffDomOptions || {})),
                                        (this.initialized = !1),
                                        (this._events = {}),
                                        (this._currentPage = 0),
                                        (this.onFirstPage = !0),
                                ...
                                _renderPagers() {
                                    ...
                                    let t = ((t, e, s, i, n) => {
                                        let a = [];
                                        if (
                                            (n.firstLast && a.push(J(1, n.firstText, n)), n.nextPrev)
                                        ) {
                                            const e = t ? 1 : s - 1;
                                            a.push(J(e, n.prevText, n, { hidden: t }));
                                        }
                                        let o = [...Array(i).keys()].map((t) =>
                                            J(t + 1, String(t + 1), n, { active: t === s - 1 })
                                        );
                                        if (
                                            (n.truncatePager &&
                                                (o = ((t, e, s, i) => {
                                            ...
                                            const t = e ? i : s + 1;
                                            a.push(J(t, n.nextText, n, { hidden: e }));
                                        }
                                        return (
                                    ...
                                    if (Array.isArray(t)) {
                                        ...
                                        t.forEach((t, i) => {
                                            ...
                                            Object.entries(t).forEach(([t, s]) => {
                                                const a = e.indexOf(t);
                                                a > -1
                                                    ? (n[a] = B(s, this.columns.settings[a]))
                                                    : this.hasHeadings ||
                                                    this.hasRows ||
                                                    0 !== i ||
                                                    ((n[e.length] = B(
                                        ...
                                        e(t) &&
                                            (!t.headings || this.hasHeadings || this.hasRows
                                                ...
                                                (s = t.data.map((t) =>
                                                    t.map((t, e) => B(t, this.columns.settings[e]))
                                                ))
                                                : (this.data = W(
                                                    t,
                                                    void 0,
